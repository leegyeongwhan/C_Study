...
struct org_tree
{
	...
	{
		org_tree tree;
		tree.root = new node {pos, NULL, NULL}; //ceo
		return tree;
	}

    static org_tree create_org_structure2(const std::string pos)
	{
		org_tree tree;
		tree.root = new node {pos, NULL, NULL}; //ceo
		return tree;
...
int main()
{
    //root node 설정 root 는 ceo
	auto tree = org_tree::create_org_structure("CEO");
    auto tree2 = org_tree::create_org_structure2("CEO");
